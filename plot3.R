...
with(plot3, plot(full_time, Sub_metering_1, type="l", 
                 xlab="", ylab="Energy sub metering", yaxt="n"))
with(plot3, lines(full_time, Sub_metering_2, type="l", col="red"))
with(plot3, lines(full_time, Sub_metering_3, type="l", col="blue"))
